...
//xyf
   ZONE6_ADUP   : origin = 0x1000C0, length = 0x000100
   ZONE6_ECATUP : origin = 0x100900, length = 0x000030
   ZONE6_ECATDOWN :origin = 0x100980,length = 0x000100
}
...
SECTIONS
{
   ...
   */
   ...
   ECATUPDATA       : > ZONE6_ECATUP    PAGE = 1
   ADUPDATA         : > ZONE6_ADUP      PAGE = 1
   ECATDOWNDATA     : > ZONE6_ECATDOWN  PAGE = 1
